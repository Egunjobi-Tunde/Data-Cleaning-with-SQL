...
in a database. It is part of the most important parts of a data analysis, before analysis can be made it is essential that
the data undergo data cleaning else it may lead to wrong analysis and result which leads to bad decision*/
